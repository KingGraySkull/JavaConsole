...
public class SelectBuilder extends AbstractSqlBuilder implements Cloneable, Serializable {
	...
	/**
	 * Adds a "union" select builder. The generated SQL will union this query with
	 * the result of the main query. The provided builder must have the same columns
	 * as the parent select builder and must not use "order by" or "for update".
	 */
